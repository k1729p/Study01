...
<META charset="UTF-8">
<BODY>
<a href="https://github.com/k1729p/Study01/tree/main/docs"><img alt="" src="images/ColorScheme.png" height="25" width="800"/></a>
<H2 id="contents">Study01 README Contents</H2>
<H3 id="top">Research OpenAPI</H3>

<img alt="" src="images/MermaidFlowchart.png" height="565" width="1020"/>
...
<OL>
<LI><a href="#ONE"><b>Study01-1-generator</b></a></LI>
<LI><a href="#TWO"><b>Study01-2-server</b></a></LI>
<LI><a href="#THREE"><b>Study01-3-client</b></a></LI>
</OL>
...
<img alt="" src="images/orangeSquare.png"> 2. With URL <a href="http://localhost:8080">http://localhost:8080</a> open in the web browser the 
<a href="https://github.com/k1729p/Study01/blob/main/2-server/src/main/resources/static/index.html">home page</a>.<br>
<img alt="" src="images/orangeSquare.png"> 3. On this
...
<img alt="" src="images/ScreenshotHomePage.png" height="390" width="590"/><BR>
...
<a href="https://github.com/k1729p/Study01/blob/main/2-server/src/main/java/kp/company/controller/DepartmentsController.java#L46">
kp.company.controller.DepartmentsController::getDepartments</a>.<br>
</P>
<P><img alt="" src="images/GetAllDepartments.png" height="655" width="305"/><BR>
<img alt="" src="images/blackArrowUp.png">
...
<P>
The controller method:
<a href="https://github.com/k1729p/Study01/blob/main/2-server/src/main/java/kp/company/controller/DepartmentsController.java#L71">
kp.company.controller.DepartmentsController::getDepartmentById</a>.<br>
</P>
<P><img alt="" src="images/GetAllDepartmentsById.png" height="320" width="280"/><BR>
<img alt="" src="images/blackArrowUp.png">
...
<P>
The controller method:
<a href="https://github.com/k1729p/Study01/blob/main/2-server/src/main/java/kp/company/controller/DepartmentsController.java#L108">
kp.company.controller.DepartmentsController::getEmployeesInDepartment</a>.<br>
</P>
<P><img alt="" src="images/GetAllEmployeesInDepartment.png" height="250" width="245"/><BR>
<img alt="" src="images/blackArrowUp.png">
...
<P>
The controller method:
<a href="https://github.com/k1729p/Study01/blob/main/2-server/src/main/java/kp/company/controller/DepartmentsController.java#L134">
kp.company.controller.DepartmentsController::getEmployeeInDepartmentByIds</a>.<br>
</P>
<P><img alt="" src="images/GetAllEmployeesInDepartmentByIds.png" height="115" width="220"/><BR>
<img alt="" src="images/blackArrowUp.png">
...
<P>
The controller method:
<a href="https://github.com/k1729p/Study01/blob/main/2-server/src/main/java/kp/company/controller/EmployeesController.java#L39">
kp.company.controller.EmployeesController::getEmployees</a>.<br>
</P>
<P><img alt="" src="images/GetAllEmployees.png" height="455" width="245"/><BR>
<img alt="" src="images/blackArrowUp.png">
...
<P>
The controller method:
<a href="https://github.com/k1729p/Study01/blob/main/2-server/src/main/java/kp/company/controller/TitlesController.java#L37">
kp.company.controller.TitlesController::getTitles</a>.<br>
</P>
<P><img alt="" src="images/GetAllTitles.png" height="95" width="125"/><BR>
<img alt="" src="images/blackArrowUp.png">
...
<P><img alt="" src="images/ApiDocumentation.png" height="835" width="360"/><BR>
<img alt="" src="images/blackArrowUp.png">
...
<P><img alt="" src="images/Actuator.png" height="280" width="480"/><BR>
<img alt="" src="images/blackArrowUp.png">
...
<a href="https://github.com/k1729p/Study01/blob/main/2-server/src/main/java/kp/company/controller/DepartmentsController.java#L59">
kp.company.controller.DepartmentsController::createDepartment</a><br>
<a href="https://github.com/k1729p/Study01/blob/main/2-server/src/main/java/kp/company/controller/DepartmentsController.java#L120">
...
<a href="https://github.com/k1729p/Study01/blob/main/2-server/src/main/java/kp/company/controller/DepartmentsController.java#L95">
kp.company.controller.DepartmentsController::updateDepartment</a><br>
<a href="https://github.com/k1729p/Study01/blob/main/2-server/src/main/java/kp/company/controller/DepartmentsController.java#L160">
kp.company.controller.DepartmentsController::updateEmployeeInDepartment</a></LI>
<LI>The methods for '<i>DELETE</i>':<br>
<a href="https://github.com/k1729p/Study01/blob/main/2-server/src/main/java/kp/company/controller/DepartmentsController.java#L83">
kp.company.controller.DepartmentsController::deleteDepartment</a><br>
<a href="https://github.com/k1729p/Study01/blob/main/2-server/src/main/java/kp/company/controller/DepartmentsController.java#L147">
...
<P><img alt="" src="images/ClientApplicationCallEndpoints.png" height="190" width="755"/><BR>
<img alt="" src="images/blackArrowUp.png">
