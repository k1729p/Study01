...
import static kp.TestConstants.CREATED_DEPARTMENT_INVALID_DEP_CONTENT;
import static kp.TestConstants.CREATED_DEPARTMENT_INVALID_EMP_CONTENT;
...
import static kp.TestConstants.CREATED_EMPLOYEE_TITLE;
import static kp.TestConstants.DEPARTMENTS_PATH;
import static kp.TestConstants.DEPARTMENT_BY_ABSENT_ID_PATH;
import static kp.TestConstants.DEPARTMENT_BY_BAD_ID_PATH;
import static kp.TestConstants.DEPARTMENT_BY_ID_PATH;
import static kp.TestConstants.DEPARTMENT_BY_INVALID_ID_PATH;
import static kp.TestConstants.DEP_TEST_INDEX_UPPER_BOUND;
import static kp.TestConstants.DEP_TEST_SIZE;
import static kp.TestConstants.EMPLOYEES_IN_DEPARTMENT_PATH;
import static kp.TestConstants.EMPLOYEE_IN_DEPARTMENT_BY_ABSENT_ID_PATH;
import static kp.TestConstants.EMPLOYEE_IN_DEPARTMENT_BY_BAD_ID_PATH;
import static kp.TestConstants.EMPLOYEE_IN_DEPARTMENT_BY_ID_PATH;
import static kp.TestConstants.EMPLOYEE_IN_DEPARTMENT_BY_INVALID_ID_PATH;
import static kp.TestConstants.EMP_CREATED_SIZE;
...
import static kp.TestConstants.EXPECTED_EMPLOYEE_TITLE;
...
import static kp.TestConstants.UPDATED_EMPLOYEE_TITLE;
import static kp.TestConstants.VALIDATION_FAILED_DEP_MSG;
import static kp.TestConstants.VALIDATION_FAILED_DEP_MSG_LIST;
import static kp.TestConstants.VALIDATION_FAILED_EMP_MSG;
import static kp.TestConstants.VALIDATION_FAILED_EMP_MSG_LIST;
...
class DepartmentControllerTests {
	...
	/**
	 * Should get the {@link Department}s.<br>
	 ...
	 * department with invalid department data.<br>
	 * Tests a <b>POST</b> request.
	 * 
	 * @throws Exception the {@link Exception}
	 */
	...
	/**
	 * Should fail validation and get '400 Bad Request' error response when creating
	 * department with invalid employee data.<br>
	 * Tests a <b>POST</b> request.
	 * 
	 * @throws Exception the {@link Exception}
	 */
	...
	/**
	 * Should get the {@link Department} by id.<br>
	 * Tests a <b>GET</b> request.
	 * 
	 * @throws Exception the {@link Exception}
	 */
	 ...
	 * the {@link Department} by invalid id.<br>
	 * Tests a <b>GET</b> request.
	 * 
	 * @throws Exception the {@link Exception}
	 */
	...
	/**
	 * Should get the {@link Employee}s in the {@link Department}.<br>
	 * Tests a <b>GET</b> request.
	 * 
	 * @throws Exception the {@link Exception}
	 */
	...
	/**
	 * Should create the {@link Employee} in the {@link Department}.<br>
	 * Tests a <b>POST</b> request.
	 * 
	 * @throws Exception the {@link Exception}
	 */
	...
	/**
	 * Should get the {@link Employee} in the {@link Department} by id.<br>
	 * Tests a <b>GET</b> request.
	 * 
	 * @throws Exception the {@link Exception}
	 */
	...
	/**
	 * Should fail validation and get '400 Bad Request' error response when getting
	 * the {@link Employee} by invalid id.<br>
	 * Tests a <b>GET</b> request.
	 * 
	 * @throws Exception the {@link Exception}
	 */
	...
	/**
	 * Should delete the {@link Employee} in the {@link Department}.<br>
	 * Tests a <b>DELETE</b> request.
	 * 
	 * @throws Exception the {@link Exception}
	 */
	...
	/**
	 * Should update the {@link Employee} in the {@link Department}.<br>
	 * Tests a <b>PATCH</b> request.
	 * 
	 * @throws Exception the {@link Exception}
	 */
