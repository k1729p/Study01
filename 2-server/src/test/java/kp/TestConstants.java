...
public class TestConstants {
	...
	public static final String VALIDATION_FAILED_DEP_MSG = "getDepartmentById.depId: must be greater than or equal to 1";
	...
	public static final String CREATED_EMPLOYEE_CONTENT = String.format(
			"{\"id\":%d,\"firstName\":\"%s\",\"lastName\":\"%s\",\"title\":\"%s\"}", CREATED_EMPLOYEE_ID,
			CREATED_EMPLOYEE_F_NAME, CREATED_EMPLOYEE_L_NAME, CREATED_EMPLOYEE_TITLE);
	public static final String CREATED_DEPARTMENT_CONTENT = String.format(
			"{\"id\":%d,\"name\":\"%s\",\"employees\":[%s]}", CREATED_DEPARTMENT_ID, CREATED_DEPARTMENT_NAME,
			CREATED_EMPLOYEE_CONTENT);
	public static final String CREATED_DEPARTMENT_INVALID_DEP_CONTENT = String
			.format("{\"id\":0,\"name\":\"~\",\"employees\":[%s]}", CREATED_EMPLOYEE_CONTENT);
	public static final String CREATED_DEPARTMENT_INVALID_EMP_CONTENT = String.format(
			"{\"id\":%d,\"name\":\"%s\",\"employees\":["
					+ "{\"id\":0,\"firstName\":\"~\",\"lastName\":\"~\",\"title\":\"%s\"}]}",
	...
	public static final String UPDATED_DEPARTMENT_CONTENT = String.format(
			"{\"name\":\"%s\",\"employees\":"
					+ "[{\"id\":%d,\"firstName\":\"%s\",\"lastName\":\"%s\",\"title\":\"%s\"}]}",
	...
	public static final String UPDATED_EMPLOYEE_CONTENT = String.format(
			"{\"firstName\":\"%s\",\"lastName\":\"%s\",\"title\":\"%s\"}", UPDATED_EMPLOYEE_F_NAME,
			UPDATED_EMPLOYEE_L_NAME, UPDATED_EMPLOYEE_TITLE);
